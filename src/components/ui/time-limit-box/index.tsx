...
import { Clock } from "@/components/ui/icons/icons";
...
export const TimeLimitBox = memo(
  ({ target_date, idScrollArea, completed = false }: props) => {
    ...
    useOnClickOutside(timeLimitRef, () => setIsTooltip(false));
    ...
    const formatDate = (dateString: string | Date): string => {
      ...
      if (isTomorrow(date, now))
        return (
          "Mañana" + (hasTimeComponent(date) ? `, ${formatTime(date)}` : "")
        );
