...
//     if (!path || !svg || !check || path.getAttribute("d") === null) return;
...
export function Checkbox({
  ...
  function togglePath() {
    ...
    animate(svg, { transform: "scale(0.75)" }, { duration: 0.1 }).then(() => {
      animate(0, 1, {
        duration: 0.1,
        ease: "easeInOut",
        onUpdate: (progress) => {
        ...
        animate(svg, { transform: "scale(1)" }, { duration: 0.1 });
        animate(0, 1, {
          duration: 0.1,
          ease: "easeInOut",
          onUpdate: (progress) => {
