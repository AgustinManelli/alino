export const HomeLayouts = {
	...
	md: [
		{ i: "summary", x: 0, y: 0, w: 2, h: 1, isResizable: false, minW: 1, maxW: 1, minH:1, maxH: 1 },
		{ i: "upcoming-tasks", x: 0, y: 1, w: 1, h: 1, minW: 1, maxW: 1, minH:1, maxH: 2 },
		{ i: "pomodoro", x: 0, y: 2, w: 1, h: 1, isResizable: false },
		{ i: "new-features", x: 0, y: 3, w: 1, h: 1, isResizable: false },
		{ i: "weather", x: 0, y: 4, w: 1, h: 1, isResizable: false },
